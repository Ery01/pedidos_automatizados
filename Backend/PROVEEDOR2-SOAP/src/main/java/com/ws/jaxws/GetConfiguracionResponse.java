...
@XmlRootElement(name = "getConfiguracionResponse", namespace = "http://ws.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getConfiguracionResponse", namespace = "http://ws.com/")

public class GetConfiguracionResponse {
